...
export const site = {
  ...
  counter: {
    ...
    namespace: 'oratorio-digital-contador-2026-06-14-start',
...
export const ui = {
  'pt-BR': {
    ...
    community_label: 'orações já elevadas pela comunidade',
    community_join: 'Cada oração concluída acende mais uma luz.',
    liturgical_title: 'Tempo de orar',
    liturgical_seal: 'Tempo de orar',
  ...
  en: {
    ...
    community_label: 'prayers already raised by the community',
    community_join: 'Each completed prayer lights one more flame.',
    liturgical_title: 'Time to pray',
    liturgical_seal: 'Time to pray',
