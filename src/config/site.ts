...
export const ui = {
  'pt-BR': {
    ...
    produtos_related: 'Produtos relacionados',
    produtos_disclosure: 'Alguns links são de afiliados e podem gerar uma pequena comissão para manter o site no ar.',
    produtos_title: 'Produtos',
    produtos_lead: 'Indicações relacionadas às orações e aos santos. Alguns links são de afiliados e ajudam a manter o site no ar.',
    produtos_empty: 'Nenhum produto cadastrado ainda.',
    prodcat_livro: 'Livros', prodcat_vestuario: 'Vestuário', prodcat_acessorio: 'Acessórios', prodcat_arte: 'Arte e imagens', prodcat_terco: 'Terços e rosários', prodcat_medalha: 'Medalhas', prodcat_curso: 'Cursos', prodcat_outro: 'Outros',
    theme_toggle: 'Modo claro/escuro',
    nav_tempos: 'Tempos litúrgicos',
    season_until: 'até',
    season_then: 'depois,',
    season_learn: 'Entenda os tempos litúrgicos',
    nav_textos: 'Textos',
    search_label: 'Buscar',
    lang_label: 'Idioma',
    textos_title: 'Textos',
    textos_lead: 'Leituras para entender e viver melhor a fé — aos poucos, novos textos vão aparecendo aqui.',
    filter_type: 'Tipo',
    filter_lang: 'Idioma',
    type_oracao: 'Oração',
    type_novena: 'Novena',
  ...
  en: {
    ...
    produtos_related: 'Related products',
    produtos_disclosure: 'Some links are affiliate links and may earn a small commission to keep the site running.',
    produtos_title: 'Products',
    produtos_lead: 'Recommendations related to the prayers and saints. Some links are affiliate links that help keep the site running.',
    produtos_empty: 'No products yet.',
    prodcat_livro: 'Books', prodcat_vestuario: 'Apparel', prodcat_acessorio: 'Accessories', prodcat_arte: 'Art & images', prodcat_terco: 'Rosaries', prodcat_medalha: 'Medals', prodcat_curso: 'Courses', prodcat_outro: 'Other',
    theme_toggle: 'Light/dark mode',
    nav_tempos: 'Liturgical seasons',
    season_until: 'until',
    season_then: 'then',
    season_learn: 'About the liturgical seasons',
    nav_textos: 'Texts',
    search_label: 'Search',
    lang_label: 'Language',
    textos_title: 'Texts',
    textos_lead: 'Readings to better understand and live the faith — new texts will appear here over time.',
    filter_type: 'Type',
